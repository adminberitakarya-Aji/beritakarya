      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Produktivitas & Performa Wartawan</p>
          </div>
        </div>
        ...
        <div className="relative w-full md:w-64">
          ...
          <input 
            type="text"
            placeholder="Cari nama wartawan..."
            value={search}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          <div className="col-span-full py-20 text-center text-gray-400">
            ...
            <p className="text-sm font-bold uppercase tracking-widest">Tidak ada wartawan ditemukan</p>
          </div>
        ) : (
