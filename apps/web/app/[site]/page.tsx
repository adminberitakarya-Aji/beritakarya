...
async function getArticles(siteId: string, category?: string, search?: string) {
  try {
    ...
    // Fetch more articles to support complex layout
...
export default async function SiteHomePage({ 
  ...
  const popular = articlesList.slice(0, 5) // In real world, fetch by view count
      ...
      <main id="main-content" className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <aside className="lg:col-span-4 space-y-16">
            ...
            {/* Video Widget (Optional - based on site settings) */}
